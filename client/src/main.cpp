...
int main() {
    ...
    try {
        ...
        Network::Type::StunMessageHeader responseHeader{};
        ...
        switch (responseHeader.message_type) {
            case 0x0101:
                std::cout << "Stun Message Type Success " << "\n";
                break;
            case 0x0111:
                std::cout << "Stun Message Type Failure " << "\n";
               return 1;
            default:
                std::cout << "Stun Message Type Unknown Error " << "\n";
                return -1;
        }
